...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 38797 or testnet: 48797)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 38798 or testnet: 48798)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Liteblocks Wiki for SSL setup instructions)") + "\n" +
